...
export const generator ={
  ...
  "nodes": [
    ...
    {
      "name": "conversation_1748526696749",
      "type": "conversation",
      "metadata": {
        "position": {
          "x": 0,
          "y": 241.91617831194458
        }
      },
    ...
    },
    {
      ...
      "tool": {
        "url":"https://ai-mock-interview-sooty-seven.vercel.app/api/vapi/generate",
        "body": {
          "type": "object",
          "properties": {
            "role": {
    ...
    {
      "name": "conversation_1748587263069",
      "type": "conversation",
      "metadata": {
        "position": {
          "x": 0,
    ...
    {
      "name": "hangup_1748587369621",
      "type": "tool",
      "metadata": {
        "position": {
          "x": 0.5141181864126452,
          "y": 1004.2315854791582
        }
      },
      "tool": {
        "type": "endCall"
  ...
  "edges": [
    ...
    {
      "from": "conversation_1748526696749",
      "to": "API Request",
      "condition": {
        "type": "ai",
        "prompt": ""
    ...
    {
      "from": "conversation_1748587263069",
      "to": "hangup_1748587369621",
      "condition": {
        "type": "ai",
        "prompt": ""
      }
